...
Persistent local storage for app settings, completed transcripts, and batch run records. Backed by a single SQLite database on the user's machine, replacing the previous per-file JSON stores.
